...
- Relax and have fun
- Play quickly without thinking too much
...
- Understand the result of each spin

Frustrations:

- Unknown terms like "wild" or "scatter"
- No instructions
...
1. As a casual player, Alex wants to clearly see the game results after each spin so that he can quickly understand if he wins or loses.
2. As a new user, Mia wants clear instructions so that she can learn how to play quickly.

### Apps to be researched: Guns ‘n’ Roses, Dead or Alive 2, Age of The Gods 2
