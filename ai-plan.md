...
Our initial strategy for using AI is:

1. Do research first so prompts are specific.
2. Ask AI for small, focused changes instead of large full-project rewrites.
3. Review the generated code after each prompt.
4. Run tests/linting as we go.
5. Log every important AI interaction in `ai-use-log.md`.
6. If AI fails to fix something, try again with a clearer prompt before hand-editing.

## How We Plan To Use AI

We expect to use AI for:

- generating or revising small pieces of code
- helping write tests
